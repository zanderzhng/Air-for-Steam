"friends/voicebar.res"
{
	styles {
		CVoiceBar {
			render_bg {
				0="fill( x0, y0, x1 + 9999, y1, Focus4 )"
			}
		}
		...
		CVoiceTraffic {
			...
			minimum-width=72
			render_bg {
				0="fill( x0 + 35, y0 + 6, x0 + 38, y0 + 14, Focus4 )"
				1="fill( x0 + 39, y0 + 6, x0 + 42, y0 + 14, Focus4 )"
				2="fill( x0 + 43, y0 + 6, x0 + 46, y0 + 14, Focus4 )"
				3="fill( x0 + 47, y0 + 6, x0 + 50, y0 + 14, Focus4 )"
				4="fill( x0 + 51, y0 + 6, x0 + 54, y0 + 14, Focus4 )"
				5="fill( x0 + 55, y0 + 6, x0 + 58, y0 + 14, Focus4 )"
				6="fill( x0 + 59, y0 + 6, x0 + 62, y0 + 14, Focus4 )"
				7="fill( x0 + 63, y0 + 6, x0 + 66, y0 + 14, Focus4 )"
			}
		}
